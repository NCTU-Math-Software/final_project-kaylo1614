# special life game
使用者須輸入:空間大小(n)(代表空間最多只有n*n個生物)、起始人口數(t)(之後要在塗上點t個點，會將那些點變成青年)
這個程式是在一個n*n的平面上，在地圖上放置t個某物種的青年，之後模擬單一物種的繁衍，而該物種分為幼年，青年，壯年，跟老年狀態，只要周圍沒有太多人競爭糧食，該物種就會進入下一個時期，且有機會繁衍。
